...
const MagicButton = ({
  ...
  return (
    <button className="relative inline-flex h-12 w-full rounded-lg overflow-hidden  p-[1px] focus:outline-none focus:ring-offset-slate-50 md:w-60 md:mt-10" handleClick={handleClick}>
